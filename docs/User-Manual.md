...
CyberTelly was developed using Python alongside python-vlc and PySide6, the Python bindings for VLC and the Qt6 framework. Everybody who would like to get an idea how it works, can have a look at the source code: Set up a virtual Python environment, install the required modules using requirements-x64.txt or requirements-arm64.txt and start coding!<br/><br/>
